...
namespace 云湖WP
{
    ...
    public sealed partial class BotsPage : Page
    {
        ...
        private ObservableCollection<FriendContactItem> _botsList = new ObservableCollection<FriendContactItem>();
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            BotsListView.ItemsSource = _botsList;
        ...
        private async Task LoadBotsAsync()
        {
            ...
            try
            {
                ...
                if (result.IsSuccess && result.Bots != null)
                {
                    _botsList.Clear();
                    ...
                    if (_botsList.Count == 0 && EmptyPanel != null)
                    {
                        EmptyPanel.Visibility = Visibility.Visible;
                    }

                    PreloadAvatars(result.Bots);
                }
                else
                {
                    if (_botsList.Count == 0 && EmptyPanel != null)
            ...
            if (errMsg != null)
            {
                var dialog = new MessageDialog(errMsg, "云湖机器人");
        ...
        private void BotsListView_ItemClick(object sender, ItemClickEventArgs e)
        {
